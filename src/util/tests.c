...
void test3() {
    ...
    EntityRecord entityRecord = {array};
    ...
    EntityRecord entityRecord2 = {array1};
    ...
    assertEqualsS(cutString(entityRecord22->fields[1].data, 0, entityRecord22->fields[1].dataSize), "Ksenia Kirillova",
                  "value2", 3, 20);
...
void test5() {
    ...
    EntityRecord entityRecord = {array1};
    ...
    EntityRecord entityRecord2 = {array2};
    ...
    EntityRecord entityRecord3 = {array3};
    ...
    assertEqualsS(cutString((char *) entityRecord1->fields[0].data, 0, entityRecord1->fields[0].dataSize), "Ksenia",
                  "name", 5, 3);
    ...
    assertEqualsS(cutString((char *) entityRecord1->fields[0].data, 0, entityRecord1->fields[0].dataSize), "Nikita",
                  "name", 5, 8);
    assertEqualsS(cutString((char *) entityRecord1->fields[1].data, 0, entityRecord1->fields[0].dataSize), "Ivanov",
                  "surname", 5, 9);
    ...
    entityRecord1 = next(iterator, file);
    assertEqualsS(cutString((char *) entityRecord1->fields[0].data, 0, entityRecord1->fields[0].dataSize), "Lubovv",
                  "name", 5, 13);
...
void test6() {
    ...
    assertEqualsS(cutString((char *) entityRecord->fields[0].data, 0, entityRecord->fields[0].dataSize), "Nikita",
                  "name", 6, 3);
    assertEqualsS(cutString((char *) entityRecord->fields[1].data, 0, entityRecord->fields[1].dataSize), "Ivanov",
                  "surname", 6, 4);
    ...
    assertEqualsS(cutString(pEntityRecord->fields[0].data, 0, pEntityRecord->fields[0].dataSize), "Nikita", "name", 6,
                  8);
    fclose(file);
}
...
void test7() {
    ...
    assertEqualsS(cutString(entityRecord->fields[0].data, 0, entityRecord->fields[0].dataSize), "Nikita", "name", 7,
                  14);
    ...
    assertEqualsS(cutString(entityRecord1->fields[0].data, 0, entityRecord1->fields[0].dataSize), "Ksenia", "surname",
                  7, 23);
...
void test8() {
    ...
    bool sex = false;
    FieldValue fieldValue = {&score, sizeof(double)};
    FieldValue fieldValue1 = {surname, sizeof(char) * strlen(surname)};
...
void test10() {
    ...
    NameTypeBlock nameTypeBlocks3[7] = {
            *nameTypeBlock1,
            *nameTypeBlock2,
            *nameTypeBlock3,
            *nameTypeBlock4,
    ...
    EntityRecord entityRecord1 = {array1};
    ...
    EntityRecord entityRecord4 = {array4};
    ...
    EntityRecord entityRecord5 = {array5};
    ...
    EntityRecord entityRecord6 = {array6};
    ...
    assertEqualsS(cutString((char *) entityRecord->fields[5].data, 0, entityRecord->fields[5].dataSize), "Entropy",
                  "Name", 10, 5);
    ...
    assertEqualsS(cutString((char *) entityRecord->fields[0].data, 0, entityRecord->fields[0].dataSize), "Ivan", "Name",
                  10, 7);
    assertEqualsS(cutString((char *) entityRecord->fields[1].data, 0, entityRecord->fields[1].dataSize), "Bobrov",
                  "Surname", 10, 8);
